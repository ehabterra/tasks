...
// MountListHandler configures the mux to serve the "tasks" service "list"
// endpoint.
...
// the "tasks" service "list" endpoint.
func NewListHandler(
...
// MountShowHandler configures the mux to serve the "tasks" service "show"
// endpoint.
...
// the "tasks" service "show" endpoint.
func NewShowHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountAddHandler configures the mux to serve the "tasks" service "add"
// endpoint.
...
// the "tasks" service "add" endpoint.
func NewAddHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountUpdateHandler configures the mux to serve the "tasks" service "update"
// endpoint.
...
// calls the "tasks" service "update" endpoint.
...
// MountRemoveHandler configures the mux to serve the "tasks" service "remove"
// endpoint.
...
// calls the "tasks" service "remove" endpoint.
...
// MountStatusHandler configures the mux to serve the "tasks" service "status"
// endpoint.
