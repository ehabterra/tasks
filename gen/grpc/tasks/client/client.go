...
// List calls the "List" function in taskspb.TasksClient interface.
...
// Show calls the "Show" function in taskspb.TasksClient interface.
func (c *Client) Show() goa.Endpoint {
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		...
		if err != nil {
			...
			case *taskspb.ShowNotFoundError:
...
// Add calls the "Add" function in taskspb.TasksClient interface.
...
// Update calls the "Update" function in taskspb.TasksClient interface.
...
// Remove calls the "Remove" function in taskspb.TasksClient interface.
...
// Status calls the "Status" function in taskspb.TasksClient interface.
func (c *Client) Status() goa.Endpoint {
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		inv := goagrpc.NewInvoker(
			BuildStatusFunc(c.grpccli, c.opts...),
			EncodeStatusRequest,
			nil)
		res, err := inv.Invoke(ctx, v)
		if err != nil {
